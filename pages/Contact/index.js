  ...
  return (
    <Layout>
      <div className="contact">
        ...
        <h1 className="contact-title">HÃY LIÊN HỆ VỚI CHÚNG TÔI</h1>
        <div className="contact-content">
          <div className="contact-contact">
            <div className="contact-other">
              <div className="contact-info">
                <h2 className="contact-h2">More Methods </h2>
                <h3 className="contact-h3">Email</h3>
                <div className="contact-svg-wrap">
                  <a className="contact-a" href="mailto:connor@connorgaunt.com">
                    <svg
                ...
                <h3 className="contact-h3">Connect</h3>
                <div className="contact-svg-wrap">
                  <a
                    className="contact-a"
                    href="http://instagram.com/connorgaunt"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <svg
                  ...
                  <a
                    className="contact-a"
                    href="http://twitter.com/connor_gaunt"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <svg
                  ...
                  <a
                    className="contact-a"
                    href="http://facebook.com/connorgauntdesign"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <svg
                  ...
                  <a
                    className="contact-a"
                    href="http://linkedin.com/in/connorgaunt"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <svg
            ...
            <div className="contact-form">
              <h1>Get In Touch</h1>
              <form action>
                <div className="contact-flex-rev">
                  <input
                    type="text"
